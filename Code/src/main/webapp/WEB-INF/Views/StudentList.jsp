    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'about', title: '简介', width: 250},
                ]],
                toolbar:'#toolbar'
            });
        ...
        function deleteStudent() {
            ...
            if(selectLength == 0){
                ...
                var message = confirm("确定要删除该学生信息吗?");
                if(message == true){
                    $.ajax({
                        type:'post',
                        url:'deleteStudentData?t' + new Date().getTime(),
                        data:{ids:ids},
                        dataType:'json',
        ...
        function submitAddForm() {
            $("#addForm").form('submit',{
                url:'addStudentData?t' + new Date().getTime(),
                datatype:'json',
                type:'post',
                success:function (data) {
                    //必须将JSON字符串转换为对象
        ...
        function editStudent() {
            ...
            if (selectLength == 0) {
                ...
                $("#edit_about").textbox("setValue",selectRow.about);
            }
        }
        ...
        function submitEditForm() {
            $("#editForm").form('submit',{
                url:'editStudentData?t' + new Date().getTime(),
                datatype:'json',
                type:'post',
                success:function (data) {
                    //必须将JSON字符串转换为对象
...
<div>
    <h2 style="float: left;width: 500px">xx学校教务管理系统 || 学生信息</h2>
</div>
...
<div class="easyui-layout" style="width:100%;height:600px;">
    ...
    <div data-options="region:'center',title:'主页'">
        ...
        <div id="tt" class="easyui-tabs" data-options="fit:true,border:false,plain:false">
            ...
            <div title="Main">
                <table id="dg" title="学生列表" style="width:100%;height:100%"></table>
                ...
                <div id="toolbar" style="padding:5px;height:auto">
                    <div style="margin-bottom:5px">
                        ...
                        <span style="float: right">
                            ...
                            学生名称：<input id="studentname" class="easyui-textbox" name="studentname" style="width: 150px"/>
                            学号：<input id="studentnumber" class="easyui-textbox" name="studentnumber" style="width: 150px"/>
                                <a onclick="searchStudent()" href="javascript:void(0)" class="easyui-linkbutton"
                ...
                <!-- 添加信息对话框 -->
                <div id="addDialog" class="easyui-dialog" title="添加学生信息" data-options="iconCls:'icon-add'" style="width:600px;height:600px;padding:10px">
                ...
                <%--修改信息对话框--%>
                <div id="editDialog" class="easyui-dialog" title="修改学生信息" data-options="iconCls:'icon-edit'" style="width:600px;height:600px;padding:10px">
                    <form id="editForm" style="padding: 0 50px 20px 50px">
                        <table cellpadding="10" style="font-size: 20px;color: #6b9cde;padding: 0 0 0 50px">
                            ...
                            <tr>
                                <td>学号:</td>
                                <td>
                                    <input id="edit_no" class="easyui-textbox" type="text" name="no" prompt="请输入学号" data-options="required:true"  validType="student_no"/>
                                </td>
                            </tr>
